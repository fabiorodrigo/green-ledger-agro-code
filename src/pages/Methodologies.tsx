...
export const methodologiesData = [
  ...
  },
  {
    ...
    eligibility: "Propriedades rurais com implantação de SAF em áreas previamente de uso agrícola convencional.",
  ...
  },
  {
    code: "GL-AT-001",
    slug: "gl-at-001",
    title: "Biodigestores e Tratamento de Dejetos",
    version: "v2.0",
    program: "AgroTech",
    summary: "Quantificação de emissões evitadas pela captura e queima/aproveitamento de metano proveniente de dejetos animais.",
    eligibility: "Instalações de suinocultura, avicultura ou bovinocultura com sistema de tratamento de dejetos.",
  ...
  },
  {
    code: "GL-AT-002",
    slug: "gl-at-002",
    title: "Agricultura de Precisão e Otimização de Insumos",
    version: "v1.0",
    program: "AgroTech",
    summary: "Redução de emissões de N₂O e CO₂ por otimização na aplicação de fertilizantes e insumos agrícolas usando tecnologia de precisão.",
    eligibility: "Adoção de tecnologia de taxa variável, sensoriamento e mapeamento de produtividade.",
    mrv: "Registros de aplicação, dados de sensores, comparação com baseline regional.",
    revisions: "v1.0 (2024)",
  },
];
