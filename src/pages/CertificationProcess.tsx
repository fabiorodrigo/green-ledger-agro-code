...
const stepsPt = [
  ...
  { icon: Award, num: "06", title: "Emissão de Créditos", description: "Após verificação positiva e revisão final, a Green Ledger emite os créditos de carbono certificados, cada um com número de série único, registrados em sistema rastreável para evitar dupla contagem.", details: ["Revisão final pela equipe técnica da Green Ledger", "Dedução da contribuição ao buffer pool (quando aplicável, para mitigação de risco de não-permanência)", "Emissão dos créditos com número de série único", "Registro no sistema de rastreabilidade da Green Ledger", "Créditos disponíveis para transferência, aposentadoria ou cancelamento"] },
];
...
const stepsEn = [
  ...
  { icon: Activity, num: "04", title: "Monitoring", description: "The developer implements the approved monitoring plan, collecting data per the Measurement, Reporting and Verification (MRV) protocols of the methodology throughout the crediting period.", details: ["Monitoring plan implementation per approved PDD", "Data collection per methodology MRV protocols", "QA/QC procedures to ensure data quality", "Continuous recording in Green Ledger's system", "Monitoring report at end of each verification period"] },
  ...
  { icon: Award, num: "06", title: "Credit Issuance", description: "After positive verification and final review, Green Ledger issues the certified carbon credits, each with a unique serial number, registered in a traceable system to prevent double counting.", details: ["Final review by Green Ledger's technical team", "Buffer pool contribution deduction (when applicable, for non-permanence risk mitigation)", "Credit issuance with unique serial number", "Registration in Green Ledger's traceability system", "Credits available for transfer, retirement or cancellation"] },
];
